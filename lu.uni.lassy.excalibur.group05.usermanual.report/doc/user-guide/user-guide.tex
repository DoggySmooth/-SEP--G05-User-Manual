...
\item [\textbf{Secondary Actor}:] Furnitures Department
\item [\textbf{Intention:}] All users apart from common users can send a
...
of the order.\\ 
3. It could be that some humain ressources are needed to a specific location.
